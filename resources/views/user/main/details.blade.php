...
<div class="container-fluid pb-5">
    <div class="row px-xl-5">
        <div class="col-lg-5 mb-30">
            <div class="mb-2">
                <a href="{{ route('user#home')}}" class="text-dark" style="cursor: pointer;text-decoration:none">
        ...
        <div class="col-lg-7 h-auto mb-30 mt-4">
            <div class="h-100 bg-light p-30">
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    ...
                    <input type="text" name="" id="userId" value="{{ Auth::user()->id}}" hidden>
                    <input type="text" name="" id="pizzaId" value="{{ $pizza->id}}" hidden>
            ...
            <div class="owl-carousel related-carousel">
                ...
                <div class="product-item bg-light">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid" src="{{ asset('storage/'.$product->image)}}" style="height: :250px;width:100%" alt="{{ $product->id}}">
